...
function setUp() {
  ...
  me430CellGroup = new rosegrid.model.CellGroup(weekModel, '#33e', '#000', mtr34, 'ME430', 'C111');  
  csse490CellGroup = new rosegrid.model.CellGroup(weekModel, '#281', '#fff', [w9], 'CSSE490', 'F217');
  blankCellGroup = new rosegrid.model.CellGroup(weekModel);
  
  m3CM = weekModel.getCellModel(rosegrid.model.Weekday.MONDAY, rosegrid.model.Period.THIRD_HOUR);
  t3CM = weekModel.getCellModel(rosegrid.model.Weekday.TUESDAY, rosegrid.model.Period.THIRD_HOUR);
  r3CM = weekModel.getCellModel(rosegrid.model.Weekday.THURSDAY, rosegrid.model.Period.THIRD_HOUR);
  m4CM = weekModel.getCellModel(rosegrid.model.Weekday.MONDAY, rosegrid.model.Period.FOURTH_HOUR);
  t4CM = weekModel.getCellModel(rosegrid.model.Weekday.TUESDAY, rosegrid.model.Period.FOURTH_HOUR);
  r4CM = weekModel.getCellModel(rosegrid.model.Weekday.THURSDAY, rosegrid.model.Period.FOURTH_HOUR);
  w9CM = weekModel.getCellModel(rosegrid.model.Weekday.WEDNESDAY, rosegrid.model.Period.NINTH_HOUR);
  m10CM = weekModel.getCellModel(rosegrid.model.Weekday.MONDAY, rosegrid.model.Period.TENTH_HOUR);
}
...
function testAddCellModels() {
  var f1CM = weekModel.getCellModel(rosegrid.model.Weekday.FRIDAY, rosegrid.model.Period.FIRST_HOUR);
  assertEquals('', f1CM.getCourseName());
  assertEquals('', f1CM.getRoomNumber());
  assertSameElements([w9], csse490CellGroup.getCellIndices());
  
  var f1 = new rosegrid.model.CellIndex(rosegrid.model.Weekday.FRIDAY,  rosegrid.model.Period.FIRST_HOUR);
...
function testRemoveCellModels() {
  ...
  me430CellGroup.removeCellModels([new rosegrid.model.CellIndex(rosegrid.model.Weekday.MONDAY,  rosegrid.model.Period.THIRD_HOUR)]);
...
function testContains() {
  assertTrue(csse490CellGroup.contains(w9));
  assertFalse(csse490CellGroup.contains(m3));
}
