...
var m5 = new rosegrid.model.CellIndex(rosegrid.model.Weekday.MONDAY, rosegrid.model.Period.FIFTH_HOUR);
...
function testEquals() {
  var m4_ = new rosegrid.model.CellIndex(rosegrid.model.Weekday.MONDAY, rosegrid.model.Period.FOURTH_HOUR);
...
function testConvertNumericIndexToCellIndex() {
  assertTrue( m4.equals(rosegrid.model.CellIndex.convertNumericIndexToCellIndex(3)));
  assertTrue( m5.equals(rosegrid.model.CellIndex.convertNumericIndexToCellIndex(4)));
  assertTrue( w9.equals(rosegrid.model.CellIndex.convertNumericIndexToCellIndex(28)));
  assertFalse( m4.equals(rosegrid.model.CellIndex.convertNumericIndexToCellIndex(28))); 
}
